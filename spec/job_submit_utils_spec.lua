...
-- ###########################################################################
describe("has_partition", function()
    it("test1", function()
        assert.same(true, job_utils.has_partition("batch", "batch"))
    end)
    it("test2", function()
        assert.same(true, job_utils.has_partition("batch", ",,batch,,"))
    end)
    it("test3", function()
        assert.same(false, job_utils.has_partition("gpu", ",,batch,,"))
    end)
    it("test4", function()
        assert.same(true, job_utils.has_partition("gpu", "batch,gpu,highmem"))
    end)
    it("test5", function()
        assert.same(false, job_utils.has_partition("gpu", ""))
    end)
    it("test6", function()
        assert.same(false, job_utils.has_partition(nil, ""))
    end)
    it("test nil", function()
        assert.same(false, job_utils.has_partition(nil, nil))
    end)
end)
